  ...
  <div class="usetalking_ing">
    <table class="type07">
	 ...
	 <ul>
		 ...
		 <li></li><br>
		 <li></li><br>
		 <li class="text_style5">｜수업일 및 시간 변경은 다음날(당일수업 12시 이전) 수업부터 가능합니다.  아래 수업목록에서 <span class="usetalking_start_btn"><img src="/img/modifyicon.jpg"></span> 버튼을 클릭하세요.</li><br>
