...
'Response.write " sikorean : " & sikorean
...
function setTBooks() {
		...
		$("#m_classTB4").html(innerHtml);
		$("#m_classTB5").html(innerHtml);
		$("#m_classTB6").html(innerHtml);
		$("#m_classTB7").html(innerHtml);
...
function setTBChapter(tbv) {
		...
		else
		{
			...
			$("#m_classTC4").html(innerHtml);
			$("#m_classTC5").html(innerHtml);
			$("#m_classTC6").html(innerHtml);
			$("#m_classTC7").html(innerHtml);
		}
	...
	//alert(chdate + ' '+ chtime + ' '+ chrtime);
		...
		if (obj.length > 0 )
		{
			if ($("#span_"+obj).html() =="선택")
			{
					...
					if ($("#s_classDate0").val() != "" && $("#s_classDate1").val() != "" && $("#s_classDate2").val() != "" && $("#s_classDate3").val() != "" && $("#s_classDate4").val() != "" && $("#s_classDate5").val() != "" && $("#s_classDate6").val() != "" && $("#s_classDate7").val() != "")
					{
						alert("수강신청시 신청횟수는 1개월 8회까지(기존 수업 횟수 포함)  입니다.");
					...
					if ($("#s_classDate4").val() == chdate && $("#s_classTime4").val() == chtime )
					{
						alert("이미 선택한 수업일/시간입니다.");
						return;
					}

					if ($("#s_classDate5").val() == chdate && $("#s_classTime5").val() == chtime )
					{
						alert("이미 선택한 수업일/시간입니다.");
						return;
					}

					if ($("#s_classDate6").val() == chdate && $("#s_classTime6").val() == chtime )
					{
						alert("이미 선택한 수업일/시간입니다.");
						return;
					}

					if ($("#s_classDate7").val() == chdate && $("#s_classTime7").val() == chtime )
					{
						alert("이미 선택한 수업일/시간입니다.");
						return;
					}
					...
					if ($("#s_classDate4").val() == "" )
					{
						$("#s_classDateindex4").val(obj);
						$("#s_classDate4").val(chdate);
						$("#s_classTime4").val(chtime);
						$("#s_classMinute4").val(chrtime);
					...
					if ($("#s_classDate5").val() == "" )
					{
						$("#s_classDateindex5").val(obj);
						$("#s_classDate5").val(chdate);
						$("#s_classTime5").val(chtime);
						$("#s_classMinute5").val(chrtime);
					...
					if ($("#s_classDate6").val() == "" )
					{
						$("#s_classDateindex6").val(obj);
						$("#s_classDate6").val(chdate);
						$("#s_classTime6").val(chtime);
						$("#s_classMinute6").val(chrtime);
					...
					if ($("#s_classDate7").val() == "" )
					{
						$("#s_classDateindex7").val(obj);
						$("#s_classDate7").val(chdate);
						$("#s_classTime7").val(chtime);
						$("#s_classMinute7").val(chrtime);
			...
			else
			{
					...
					if ($("#s_classDateindex4").val() == obj )
					{
						$("#s_classDateindex4").val("");
						$("#s_classDate4").val("");
						$("#s_classTime4").val("");
						$("#s_classMinute4").val("");
					...
					if ($("#s_classDateindex5").val() == obj )
					{
						$("#s_classDateindex5").val("");
						$("#s_classDate5").val("");
						$("#s_classTime5").val("");
						$("#s_classMinute5").val("");
					...
					if ($("#s_classDateindex6").val() == obj )
					{
						$("#s_classDateindex6").val("");
						$("#s_classDate6").val("");
						$("#s_classTime6").val("");
						$("#s_classMinute6").val("");
					...
					if ($("#s_classDateindex7").val() == obj )
					{
						$("#s_classDateindex7").val("");
						$("#s_classDate7").val("");
						$("#s_classTime7").val("");
						$("#s_classMinute7").val("");
...
function fn_selClassalign()
{
	...
	for(var i=0;i<8;i++){
		...
		if ($("#s_classDateindex"+i+'').val() != "")
		{
			...
			else if (arrchgindex[4] == "")
			{
					arrchgindex[4] = $("#s_classDateindex"+i+'').val();

					if (parseInt(arrchgindex[3]) >parseInt(arrchgindex[4]) )
					{
							if (parseInt(arrchgindex[2]) > parseInt(arrchgindex[4]) )
							{
								if (parseInt(arrchgindex[1]) >parseInt(arrchgindex[4]) )
								{
										if (parseInt(arrchgindex[0]) >parseInt(arrchgindex[4]) )
										{

												arrchgindex[4] = arrchgindex[3];
												arrchgdate[4] = arrchgdate[3];
												arrchgtime[4]	= arrchgtime[3];
												arrchgrtime[4] = arrchgrtime[3];
												arrseltb[4] = arrseltb[3];
												//arrseltc[3] = arrseltc[2];
					...
					{
						arrchgindex[4] = $("#s_classDateindex"+i+'').val();
						arrchgdate[4] = $("#s_classDate"+i+'').val();
						arrchgtime[4]	= $("#s_classTime"+i+'').val();
						arrchgrtime[4] = $("#s_classMinute"+i+'').val();
						arrseltb[4] = $("#m_classTB"+i+'').val();
						//arrseltc[3] = $("#m_classTC"+i+'').val();
					}
				inum = i;
			}
			else if (arrchgindex[5] == "")
			{
					arrchgindex[5] = $("#s_classDateindex"+i+'').val();

					if (parseInt(arrchgindex[4]) >parseInt(arrchgindex[5]) )
					{
							if (parseInt(arrchgindex[3]) > parseInt(arrchgindex[5]) )
							{
								if (parseInt(arrchgindex[2]) >parseInt(arrchgindex[5]) )
								{
										if (parseInt(arrchgindex[1]) >parseInt(arrchgindex[5]) )
										{
												if (parseInt(arrchgindex[0]) >parseInt(arrchgindex[5]) )
												{

														arrchgindex[5] = arrchgindex[4];
														arrchgdate[5] = arrchgdate[4];
														arrchgtime[5]	= arrchgtime[4];
														arrchgrtime[5] = arrchgrtime[4];
														arrseltb[5] = arrseltb[4];
					...
					{
						arrchgindex[5] = $("#s_classDateindex"+i+'').val();
						arrchgdate[5] = $("#s_classDate"+i+'').val();
						arrchgtime[5]	= $("#s_classTime"+i+'').val();
						arrchgrtime[5] = $("#s_classMinute"+i+'').val();
						arrseltb[5] = $("#m_classTB"+i+'').val();
						//arrseltc[3] = $("#m_classTC"+i+'').val();
					}
				inum = i;
			}
			else if (arrchgindex[6] == "")
			{
					arrchgindex[6] = $("#s_classDateindex"+i+'').val();

					if (parseInt(arrchgindex[5]) >parseInt(arrchgindex[6]) )
					{
							if (parseInt(arrchgindex[4]) > parseInt(arrchgindex[6]) )
							{
								if (parseInt(arrchgindex[3]) >parseInt(arrchgindex[6]) )
								{
										if (parseInt(arrchgindex[2]) >parseInt(arrchgindex[6]) )
										{
												if (parseInt(arrchgindex[1]) >parseInt(arrchgindex[6]) )
												{
														if (parseInt(arrchgindex[0]) >parseInt(arrchgindex[6]) )
														{
																	arrchgindex[6] = arrchgindex[5];
																	arrchgdate[6] = arrchgdate[5];
																	arrchgtime[6]	= arrchgtime[5];
																	arrchgrtime[6] = arrchgrtime[5];
																	arrseltb[6] = arrseltb[5];
					...
					{
						arrchgindex[6] = $("#s_classDateindex"+i+'').val();
						arrchgdate[6] = $("#s_classDate"+i+'').val();
						arrchgtime[6]	= $("#s_classTime"+i+'').val();
						arrchgrtime[6] = $("#s_classMinute"+i+'').val();
						arrseltb[6] = $("#m_classTB"+i+'').val();
						//arrseltc[3] = $("#m_classTC"+i+'').val();
					}
				inum = i;
			}
			else if (arrchgindex[7] == "")
			{
					arrchgindex[7] = $("#s_classDateindex"+i+'').val();

					if (parseInt(arrchgindex[6]) >parseInt(arrchgindex[7]) )
					{
							if (parseInt(arrchgindex[5]) > parseInt(arrchgindex[7]) )
							{
								if (parseInt(arrchgindex[4]) >parseInt(arrchgindex[7]) )
								{
										if (parseInt(arrchgindex[3]) >parseInt(arrchgindex[7]) )
										{
												if (parseInt(arrchgindex[2]) >parseInt(arrchgindex[7]) )
												{
														if (parseInt(arrchgindex[1]) >parseInt(arrchgindex[7]) )
														{
																	if (parseInt(arrchgindex[0]) >parseInt(arrchgindex[7]) )
																	{
																				arrchgindex[7] = arrchgindex[6];
																				arrchgdate[7] = arrchgdate[6];
																				arrchgtime[7]	= arrchgtime[6];
																				arrchgrtime[7] = arrchgrtime[6];
																				arrseltb[7] = arrseltb[6];
					...
					{
						arrchgindex[7] = $("#s_classDateindex"+i+'').val();
						arrchgdate[7] = $("#s_classDate"+i+'').val();
						arrchgtime[7]	= $("#s_classTime"+i+'').val();
						arrchgrtime[7] = $("#s_classMinute"+i+'').val();
						arrseltb[7] = $("#m_classTB"+i+'').val();
						//arrseltc[3] = $("#m_classTC"+i+'').val();
					}
				inum = i;
			}
	...
	else
	{
	 ...
	 if (arrchgindex[4] != "")
    {
		$("#seltd_5").html(arrchgdate[4] + " " +arrchgtime[4] + " (" +arrchgrtime[4]+ " min) " );

		$("#s_classDateindex4").val(arrchgindex[4]);
		$("#s_classDate4").val(arrchgdate[4]);
		$("#s_classTime4").val(arrchgtime[4]);
		$("#s_classMinute4").val(arrchgrtime[4]);
		$("#m_classTB4").val(arrseltb[4]);
		setTBChapter('4');
		$("#m_classTC4").val(arrseltc[4]);
    }
	else
	{
	 ...
	 if (arrchgindex[5] != "")
    {
		$("#seltd_6").html(arrchgdate[5] + " " +arrchgtime[5] + " (" +arrchgrtime[5]+ " min) " );

		$("#s_classDateindex5").val(arrchgindex[5]);
		$("#s_classDate5").val(arrchgdate[5]);
		$("#s_classTime5").val(arrchgtime[5]);
		$("#s_classMinute5").val(arrchgrtime[5]);
		$("#m_classTB5").val(arrseltb[5]);
		setTBChapter('5');
		$("#m_classTC5").val(arrseltc[5]);
    }
	else
	{
	...
	if (arrchgindex[6] != "")
    {
		$("#seltd_7").html(arrchgdate[6] + " " +arrchgtime[6] + " (" +arrchgrtime[6]+ " min) " );

		$("#s_classDateindex6").val(arrchgindex[6]);
		$("#s_classDate6").val(arrchgdate[6]);
		$("#s_classTime6").val(arrchgtime[6]);
		$("#s_classMinute6").val(arrchgrtime[6]);
		$("#m_classTB6").val(arrseltb[6]);
		setTBChapter('6');
		$("#m_classTC6").val(arrseltc[6]);
    }
	else
	{
	...
	if (arrchgindex[7] != "")
    {
		$("#seltd_8").html(arrchgdate[7] + " " +arrchgtime[7] + " (" +arrchgrtime[7]+ " min) " );

		$("#s_classDateindex7").val(arrchgindex[7]);
		$("#s_classDate7").val(arrchgdate[7]);
		$("#s_classTime7").val(arrchgtime[7]);
		$("#s_classMinute7").val(arrchgrtime[7]);
		$("#m_classTB7").val(arrseltb[7]);
		setTBChapter('7');
		$("#m_classTC7").val(arrseltc[7]);
    }
	else
	{
  ...
  <div class="usetalking_ing">
    <table class="type07" style="width:100%;">
	  ...
	  <div class="text_list">
		 ...
		 <li></li><br>
		 <li class="text_style5">｜수강신청 기간은 1개월 후 까지 신청가능합니다.</li><br>
		 <li></li><br>
		 <li class="text_style5">｜수강신청 횟수는 기존 수업수를 포함하여 1개월 8회까지 신청가능합니다.</li>
		 </ul>
		</div>
...
<%
	...
	<div style="margin-left: 10px;width:800px;float:left;margin-bottom:30px;">
            ...
            <tbody>
			 ...
			 <%
				...
				If nowRunTime <> "" And m_Hour <> "" and Len(strcdates&"") > 10 Then
					...
					sql = "exec PRC_HourMin_Search_ForRegist_Search_75 '" & PiCourseSeq & "','" & Trim(strcdates&"") & "','" & sikorean & "'"
					Set Rs = dbSelect(sql)
					If Not Rs.eof Then
					...
					'Response.write ubound(arrCDatesRs)
				End If
						...
						<div class="usetalking_ing">
							<table class="type07" style="width:100%;" border=1>
							   ...
							   <tr>
							    ...
							    <tr>
								   <th style="border-top: 1px solid #ccc;width:200px;">5. 선택한 수업일 / 시간 / 진도</th>
								   <td style="border-top: 1px solid #ccc;"  id="seltd_5"></td>
								   <td style="border-top: 1px solid #ccc;" >
								   레벨 : <select name="m_classTB4" id="m_classTB4" style="width:80%;height:24px;font-size:14px;" onchange="setTBChapter('4');">
								   <%=setOption(arrTBooks, arr_classTB(4))%>
									</select>
									<br><br>
									진도 :  <select name="m_classTC4" id="m_classTC4" style="width:80%;height:24px;font-size:14px;" >
									<%=setOption(arrTBChapter, arr_classTC(4))%>
									</select>
								   </td>
							   </tr>

							   <tr>
								   <th style="border-top: 1px solid #ccc;width:200px;">6. 선택한 수업일 / 시간 / 진도</th>
								   <td style="border-top: 1px solid #ccc;"  id="seltd_6"></td>
								   <td style="border-top: 1px solid #ccc;" >
								   레벨 : <select name="m_classTB5" id="m_classTB5" style="width:80%;height:24px;font-size:14px;" onchange="setTBChapter('5');">
								   <%=setOption(arrTBooks, arr_classTB(5))%>
									</select>
									<br><br>
									진도 :  <select name="m_classTC5" id="m_classTC5" style="width:80%;height:24px;font-size:14px;" >
									<%=setOption(arrTBChapter, arr_classTC(5))%>
									</select>
								   </td>
							   </tr>

							    <tr>
								   <th style="border-top: 1px solid #ccc;width:200px;">7. 선택한 수업일 / 시간 / 진도</th>
								   <td style="border-top: 1px solid #ccc;"  id="seltd_7"></td>
								   <td style="border-top: 1px solid #ccc;" >
								   레벨 : <select name="m_classTB6" id="m_classTB6" style="width:80%;height:24px;font-size:14px;" onchange="setTBChapter('6');">
								   <%=setOption(arrTBooks, arr_classTB(6))%>
									</select>
									<br><br>
									진도 :  <select name="m_classTC6" id="m_classTC6" style="width:80%;height:24px;font-size:14px;" >
									<%=setOption(arrTBChapter, arr_classTC(6))%>
									</select>
								   </td>
							   </tr>

							   <tr>
								   <th style="border-top: 1px solid #ccc;width:200px;">8. 선택한 수업일 / 시간 / 진도</th>
								   <td style="border-top: 1px solid #ccc;"  id="seltd_8"></td>
								   <td style="border-top: 1px solid #ccc;" >
								   레벨 : <select name="m_classTB7" id="m_classTB7" style="width:80%;height:24px;font-size:14px;" onchange="setTBChapter('7');">
								   <%=setOption(arrTBooks, arr_classTB(7))%>
									</select>
									<br><br>
									진도 :  <select name="m_classTC7" id="m_classTC7" style="width:80%;height:24px;font-size:14px;" >
									<%=setOption(arrTBChapter, arr_classTC(7))%>
									</select>
								   </td>
							   </tr>
		...
		<input type="hidden" id="s_classDateindex4" name="s_classDateindex4" value=''>	<!--number id-->
		<input type="hidden" id="s_classDate4" name="s_classDate4" value=''>	<!--저장날짜1-->
		<input type="hidden" id="s_classTime4" name="s_classTime4" value=''>	<!--저장시간1-->
		<input type="hidden" id="s_classMinute4" name="s_classMinute4" value=''>	<!--저장시간1-->

		<input type="hidden" id="s_classDateindex5" name="s_classDateindex5" value=''>	<!--number id-->
		<input type="hidden" id="s_classDate5" name="s_classDate5" value=''>	<!--저장날짜1-->
		<input type="hidden" id="s_classTime5" name="s_classTime5" value=''>	<!--저장시간1-->
		<input type="hidden" id="s_classMinute5" name="s_classMinute5" value=''>	<!--저장시간1-->

		<input type="hidden" id="s_classDateindex6" name="s_classDateindex6" value=''>	<!--number id-->
		<input type="hidden" id="s_classDate6" name="s_classDate6" value=''>	<!--저장날짜1-->
		<input type="hidden" id="s_classTime6" name="s_classTime6" value=''>	<!--저장시간1-->
		<input type="hidden" id="s_classMinute6" name="s_classMinute6" value=''>	<!--저장시간1-->

		<input type="hidden" id="s_classDateindex7" name="s_classDateindex7" value=''>	<!--number id-->
		<input type="hidden" id="s_classDate7" name="s_classDate7" value=''>	<!--저장날짜1-->
		<input type="hidden" id="s_classTime7" name="s_classTime7" value=''>	<!--저장시간1-->
		<input type="hidden" id="s_classMinute7" name="s_classMinute7" value=''>	<!--저장시간1-->
