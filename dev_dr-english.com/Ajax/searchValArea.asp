...
<%
    tablename = sqlCheck(replace(request("tablename"),"'","''"))''테이블명
    searchval = sqlCheck(replace(request("searchval"),"'","''"))

    
    select case tablename
    case "tb_callcenter"
        sql = "exec PRC_tb_CallCenter_Select_SearchValueArea '" & searchval & "'"
    case else
