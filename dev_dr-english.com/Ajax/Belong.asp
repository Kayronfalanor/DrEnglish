...
<%
	...
	PnvcPBelongcode = sqlCheck(replace(request("PnvcPBelongcode"),"'","''"))


    If PnvcCPCode <> "" and PnvcPBelongcode<> "" then
    sql = "exec PRC_tb_Belong_SearchValueArea  N'" & PnvcCPCode & "', N'" & PnvcPBelongcode& "'"
