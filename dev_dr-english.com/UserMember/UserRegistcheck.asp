...
<div class="contents_right"> 
  <div><img src="/img/subimg/title_11.png" alt="회원가입"/></div>
	<div style="margin-top: 40px;">
		...
		<form name="Cform" action="UserRegist.asp" method="post">
		<input type="hidden" name="utype" id="utype" value="" />
		<input type="hidden" name="year" id="year" value="<%=Year(now)%>" />

		<p style="font-size:18px;">이용 약관</p>
		 <div class="text_list_common">		 
			<ul>
		 <li class="text_style5">내용을 확인하신 후 동의여부를 선택하세요.</li><br>		
			 </ul>
		</div>

		<table width="100%" border="0"  class="agree_txt" align="center">
			<tr>
				<td >
				<div id="scrollbox_common" class="scroll"> 
			...
			<tr>
			<td height="30" align="right" bgcolor="#F6F6F6">
				<table width="220" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="20"><input name="check1" type="checkbox" class="box" id="check1" /></td>
						<td align="right">위 이용약관에 동의합니다.</td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<p>&nbsp;</p>
		<p style="font-size:18px;">개인정보 취급방침</p>
		 <div class="text_list_common">		 
			<ul>
		 <li class="text_style5">내용을 확인하신 후 동의여부를 선택하세요.</li><br>		
			 </ul>
		...
		<table width="100%" border="0"  class="agree_txt">
			<tr>
				<td >
				<div id="scrollbox_common" class="scroll">
				<p> <span class="point02"> 개인정보 보호정책 </span><br />
				<br />
			...
			<td height="30" align="right" bgcolor="#F6F6F6">
				<table width="280" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="20"><input name="check1" type="checkbox" class="box" id="check1" /></td>
						<td align="right">위 개인정보 취급방침에 동의합니다.</td>
					</tr>
				</table>
			</td>
		</tr>
	  ...
	  <table class="type07">
           ...
           <tr>
               ...
               <td style="border-top: 1px solid #ccc;">
				<input type="text" name="UserName" type="text" class="input cssbirthday" caption="이름" id="UserName" maxlength="30" style="width:200px;height:24px;font-size:16px;" />
			    </td>
           </tr>
           <tr>
               <th scope="row">생년월일</th>
               <td colspan="">
			   <select size="1" name="birthYear" id="birthYear" class="input cssbirthday" style="width:100px;height:24px;font-size:16px;" caption="생년월일">
					<option value="">년도</option>
					<%For i = Year(now) To Year(now) - 80 Step -1%>
						<option value="<%=i%>"><%=i%>년</option>
					<%Next%>
				</select>
				&nbsp;&nbsp;
				<select size="1" name="birthMonth" id="birthMonth" class="input  cssbirthday" caption="생년월일" style="width:80px;height:24px;font-size:16px;">
				...
				&nbsp;&nbsp;
				<select size="1" name="birthDay" id="birthDay" class="input cssbirthday" style="width:80px;height:24px;font-size:16px;"caption="생년월일" >
	   ...
	   <input type="button" value="확인" class="won_gobtn"  alt="확인" border="0" id="confirmBtn" style="cursor:pointer;" caption="UserRegist.asp">
