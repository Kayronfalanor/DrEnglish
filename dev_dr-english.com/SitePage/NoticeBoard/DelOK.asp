...
Sql = "SELECT iWriterSeq, siCommentPRole FROM TB_BComment WITH(NOLOCK) WHERE iBCommentSeq = '"& seq &"' "
...
If iWriter = CLng(sUserSeq) And siPRole = CLng(sUserPRole) Then
	DB1.BeginTrans
	...
	If strResult <> "Y" Then
		msg = "Q&A 댓글 삭제 도중 오류가 발생하였습니다.\n" & strResult

		RollBackAndHistoryBack DB1, msg
	Else
		msg = "Q&A 댓글 삭제가 완료 되었습니다."
